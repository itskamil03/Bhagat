...
export default function OurCoreTeam() {
  return (
    <main className="min-h-screen bg-white text-gray-800 font-sans">
      ...
      <section className="relative w-full overflow-hidden bg-white pt-10 pb-16 px-6 lg:px-16 min-h-[460px] md:min-h-[500px] flex items-center">
        ...
        <div className="max-w-[1240px] mx-auto w-full relative z-10">
          <div className="w-full md:w-[55%] lg:w-[48%] flex flex-col justify-center">
            ...
            <nav className="text-xs md:text-sm text-gray-400 mb-6 flex items-center gap-2">
              ...
              <span>&gt;</span>
              <span className="text-[#E61B23] font-semibold">Our Core Team</span>
            </nav>

            {/* Title */}
            <h1 className="text-4xl md:text-5xl lg:text-[54px] font-extrabold leading-tight tracking-tight text-gray-900">
              OUR CORE
              <br />
            ...
            <p className="text-gray-500 mt-6 text-sm md:text-base leading-relaxed max-w-xl">
              Behind every successful project is a team of passionate professionals committed to
              engineering excellence, innovation, and customer satisfaction. Our leadership and
              management teams combine decades of industry experience to deliver reliable
              infrastructure solutions across India.
            </p>

            {/* Accent Box */}
            <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-red-100 shadow-[0_4px_15px_rgba(230,27,35,0.04)] w-fit mt-8">
        ...
        <div className="max-w-[1240px] mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {leaders.map((leader, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl shadow-[0_6px_20px_rgba(0,0,0,0.04)] border border-gray-100 overflow-hidden flex flex-col hover:shadow-lg transition-all duration-300 group"
              >
                {/* Photo Container */}
        ...
        <div className="max-w-[1240px] mx-auto">
          ...
          <div className="flex items-center justify-center gap-2 md:gap-4 mb-8">
            ...
            <h2 className="text-gray-900 font-bold tracking-[0.15em] md:tracking-[0.25em] text-xs md:text-sm uppercase text-center">
              TOGETHER WE <span className="text-[#E61B23]">BUILD</span> THE FUTURE
            </h2>
            <span className="w-1.5 h-1.5 rounded-full bg-[#E61B23]" />
            <span className="flex-grow h-[1px] bg-gradient-to-l from-transparent to-red-400" />
          </div>
          ...
          <p className="text-gray-500 text-center max-w-3xl mx-auto text-sm md:text-base leading-relaxed mb-12">
            Our greatest strength is our people. Engineers, project managers, technical specialists,
            and support professionals work together with one shared purpose—to deliver quality
            engineering solutions that power industries, strengthen infrastructure, and create lasting
            value for our clients.
          </p>

          {/* Large Team Image (Exactly 1352x573 styled responsively) */}
          <div className="relative w-full aspect-[1.5/1] md:aspect-[2.35/1] rounded-2xl overflow-hidden shadow-lg border border-gray-100 mb-8">
            <Image
          ...
          {/* Career Banner Panel */}
          <div className="w-full bg-white rounded-xl border border-gray-150 p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] mt-12">
            {/* Banner Left Info */}
            <div className="flex flex-col md:flex-row gap-5 items-start md:items-center">
              ...
              <div>
                <h4 className="font-extrabold text-base md:text-lg text-gray-900 leading-snug">
                  Great Projects Start With <span className="text-[#E61B23]">Great People.</span>
                </h4>
                <p className="text-gray-500 text-xs md:text-sm mt-1 leading-normal max-w-xl">
                  Join our growing team and contribute to projects that are shaping India&apos;s
                  electrical and infrastructure landscape.
                </p>
              </div>
            </div>
