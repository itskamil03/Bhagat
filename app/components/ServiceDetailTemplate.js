          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center gap-4 sm:gap-5 w-full">
              <a
                ...
                className="w-full sm:w-auto justify-center bg-red-600 text-white px-8 py-3.5 rounded-full font-semibold hover:bg-red-700 transition shadow-lg shadow-red-600/20 flex items-center gap-2 text-sm"
              >
              ...
              <a
                ...
                className="w-full sm:w-auto justify-center border-2 border-gray-300 text-gray-800 font-semibold px-7 py-3 rounded-full hover:bg-gray-200/80 hover:border-gray-400 transition flex items-center gap-2 text-sm"
              >
