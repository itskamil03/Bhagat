...
export default function Director() {
  return (
    <section className="relative w-full bg-gray-50 py-16 px-6 lg:px-20 overflow-hidden">
      ...
      <div className="max-w-[1308px] mx-auto w-full relative z-10">
        {/* TOP HEADING */}
        ...
        {/* MAIN CARD */}
        <div className="mt-8 bg-white rounded-2xl shadow-2xl p-6 lg:p-10 flex flex-col lg:flex-row gap-8">
          {/* LEFT IMAGE */}
...
function Feature({ title, desc }) {
  return (
    <div className="flex gap-4 items-start bg-gray-50 p-4 rounded-xl">
      {/* ICON */}
      <div className="w-10 h-10 flex items-center justify-center bg-red-100 text-red-600 rounded-full text-xl shrink-0">
        ★
      </div>
