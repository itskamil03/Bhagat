    ...
    <section className="w-full h-auto md:h-[110vh] text-white relative overflow-hidden bg-[#530503] pb-12 md:pb-0">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none select-none overflow-hidden">
        ...
        <div 
          ...
          style={{
            background: "linear-gradient(90deg, rgba(83, 5, 3, 0.88) 0%, rgba(166, 14, 8, 0.45) 55%, rgba(82, 8, 5, 0.19) 100%)"
          }}
        />
      </div>
        ...
        >
          ...
          <div className="flex-1 md:flex-none md:w-[298px] flex flex-col gap-5 animate-downSlow">
            {[...colLeft, ...colLeft].map((img, i) => (
              <div key={i} className="w-full max-w-[298px] h-[180px] md:h-[317px] flex-shrink-0 mx-auto">
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="visible"
        whileHover={{ backgroundColor: "rgba(160, 0, 0, 0.93)" }}
        className="relative md:absolute mt-10 md:mt-0 md:bottom-6 md:left-1/2 md:-translate-x-1/2 w-[300px] md:w-[calc(100%-32px)] max-w-[1410px] h-auto md:h-[98px] rounded-[16px] md:rounded-[6px] bg-[rgba(140,0,0,0.88)] backdrop-blur-[8px] border border-[rgba(255,255,255,0.15)] z-20 shadow-xl overflow-hidden cursor-pointer flex items-center justify-center mx-auto"
      >
        <div className="w-full h-full grid grid-cols-2 md:grid-cols-4 items-center p-2 md:p-0 md:px-6">
          {/* Column 1 */}
          <Link href="/about" className="h-full w-full block">
            <motion.div 
          ...
          {/* Column 3 */}
          <Link href="/project" className="h-full w-full block">
            <motion.div 
              variants={itemVariants}
          ...
          {/* Column 4 */}
          <Link href="/service" className="h-full w-full block">
            <motion.div 
              variants={itemVariants}
