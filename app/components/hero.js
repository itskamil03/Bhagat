...
export default function Hero() {
  return (
    <section className="w-full h-auto lg:h-[110vh] lg:min-h-[800px] [@media(width:1024px)]:h-[calc(110vh-106px)] text-white relative overflow-hidden bg-[#530503] pb-12 lg:pb-0">
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 [@media(width:1024px)]:grid-cols-1 gap-6 px-6 pt-10 lg:pt-14 [@media(width:1680px)]:pt-32 relative z-10 w-full">
        {/* LEFT CONTENT */}
        <div className="flex flex-col justify-start [@media(width:800px)]:pt-8 [@media(width:1024px)]:items-center [@media(width:1024px)]:text-center [@media(width:900px)]:items-center [@media(width:900px)]:text-center [@media(width:900px)]:pt-10">
          <p className="text-green-400 tracking-widest text-xs md:text-sm mb-3 [@media(width:800px)]:pl-8 [@media(width:1024px)]:px-0 [@media(width:1024px)]:w-full [@media(width:1024px)]:max-w-[800px] [@media(width:1024px)]:text-left [@media(width:900px)]:px-0 [@media(width:900px)]:w-full [@media(width:900px)]:max-w-[800px] [@media(width:900px)]:text-center [@media(width:1680px)]:text-2xl [@media(width:1680px)]:mb-5">
            ESTABLISHED 1976
          </p>

          <h1 className="text-3xl md:text-4xl [@media(width:800px)]:text-5xl [@media(width:800px)]:max-w-[700px] [@media(width:1024px)]:max-w-[800px] [@media(width:800px)]:pl-8 [@media(width:1024px)]:px-0 [@media(width:1024px)]:text-justify lg:text-5xl xl:text-7xl font-bold leading-tight select-none max-w-2xl [@media(width:900px)]:text-5xl [@media(width:900px)]:max-w-[800px] [@media(width:900px)]:px-0 [@media(width:900px)]:text-center [@media(width:1680px)]:text-[4.8rem] [@media(width:1680px)]:max-w-[850px] [@media(width:1680px)]:leading-[1.1]">
            Engineering the future with legacy, precision, and innovation.
          </h1>

          <p className="text-sm md:text-base [@media(width:800px)]:text-lg [@media(width:1024px)]:text-xl [@media(width:800px)]:max-w-[650px] [@media(width:1024px)]:max-w-[800px] [@media(width:800px)]:pl-8 [@media(width:1024px)]:px-0 [@media(width:1024px)]:text-justify text-white/80 mt-4 leading-relaxed max-w-[500px] [@media(width:900px)]:text-xl [@media(width:900px)]:max-w-[800px] [@media(width:900px)]:px-0 [@media(width:900px)]:text-center [@media(width:1680px)]:text-[1.7rem] [@media(width:1680px)]:max-w-[750px] [@media(width:1680px)]:mt-8 [@media(width:1680px)]:leading-relaxed">
      ...
      <div className="w-[calc(100%-48px)] mx-auto lg:mx-0 lg:w-[48%] [@media(width:1024px)]:w-full [@media(width:1024px)]:max-w-[800px] h-[350px] sm:h-[450px] [@media(width:800px)]:h-[600px] [@media(width:1024px)]:h-[700px] lg:h-full lg:absolute [@media(width:1024px)]:relative lg:right-0 lg:top-0 overflow-hidden relative z-0 mt-8 [@media(width:800px)]:mt-12 [@media(width:1024px)]:mt-8 lg:mt-0 [@media(width:1024px)]:mx-auto [@media(width:900px)]:w-full [@media(width:900px)]:max-w-[850px] [@media(width:900px)]:h-[650px] [@media(width:900px)]:relative [@media(width:900px)]:mt-12 [@media(width:900px)]:mx-auto">
        <div
          className="absolute w-full flex justify-center gap-3 [@media(width:800px)]:gap-6 px-4 lg:px-0 lg:pr-8 [@media(width:1024px)]:px-0 [@media(width:1024px)]:pr-0 animate-parallaxRight [@media(width:900px)]:gap-8 [@media(width:900px)]:px-0"
          style={{
