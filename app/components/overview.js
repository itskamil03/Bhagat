...
export default function Overview() {
  return (
    <section className="w-full bg-[#f7eaea] mt-0 py-12 px-6">
      <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 gap-10">
        {/* LEFT CONTENT */}
        <div>
          <p className="text-red-500 font-semibold mb-3">01 — OVERVIEW</p>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          {/* CARD 1 */}
          <div className="bg-gray-300 backdrop-blur-md p-5 rounded-lg shadow-sm hover:shadow-md transition h-[200px] w-[200px]">
