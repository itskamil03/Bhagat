        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10 items-start">
          ...
          <div className="relative">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-900">Completed Project Board</h2>
              ...
              >
                {filteredProjects.length === 0 ? (
                  <div className="bg-white rounded-xl p-12 text-center border border-gray-200">
                    <p className="text-gray-500">No completed projects matching your criteria.</p>
                  </div>
                ) : (
                  filteredProjects.map((project, index) => (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-4 my-2 border-y border-gray-100">
                        ...
                        <div>
                          <p className="text-xs text-gray-400 font-semibold uppercase">Date Completed</p>
                          <p className="text-xs md:text-sm font-bold text-gray-800 mt-1 flex items-center gap-1">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#17162b] text-white rounded-2xl p-6 shadow-lg relative overflow-hidden">
              <h3 className="text-lg font-bold border-b border-white/10 pb-4 mb-6 flex items-center gap-2">
                ...
                <span>Completed Statistics</span>
              </h3>
              
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <p className="text-3xl font-extrabold text-white">04</p>
                  <p className="text-xs text-gray-400 mt-1 font-semibold">Completed Projects</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1 font-semibold">Quality Check</p>
                </div>
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
              ...
              <p className="text-xs text-gray-500 mt-3 text-center leading-relaxed">
                Key representations showing completed execution across the Indian subcontinent.
              </p>
            </div>
          </div>
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[99999] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="text-xs text-gray-400 font-bold uppercase mb-2">Scope of Operations Completed</h4>
