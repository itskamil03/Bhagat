...
export default function OngoingProjects() {
  ...
  const filteredProjects = projects.filter((proj) => {
    ...
    const matchesDivision = divisionFilter === "All" || proj.division === divisionFilter;
    const matchesLocation = locationFilter === "All" || proj.location.includes(locationFilter);
      ...
      <section className="bg-[#17162b] text-white relative overflow-hidden py-16">
        <div className="max-w-[1440px] mx-auto px-6 md:px-16 relative z-10">
          ...
          <p className="text-gray-300 mt-4 max-w-2xl text-base leading-relaxed">
            Delivering engineering excellence across recent railway, industrial, commercial, and power infrastructure structures and projects. ISO 9001:2015 Certified execution.
          </p>
        </div>
        ...
        <div className="max-w-[1240px] mx-auto px-6 flex flex-col md:flex-row gap-4 items-center">
          ...
          <div className="w-full md:w-56">
            ...
            >
              ...
              <option value="Railway Electrification">Railway Electrification</option>
              <option value="Power Infrastructure">Power Infrastructure</option>
              <option value="Energy Efficient Lighting">Energy Efficient Lighting</option>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10 items-start">
          ...
          <div className="relative">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-900">Live Project Board</h2>
              <span className="text-xs text-gray-500 italic ml-2">Auto-scrolling active</span>
            </div>
              ...
              >
                {filteredProjects.length === 0 ? (
                  <div className="bg-white rounded-xl p-12 text-center border border-gray-200">
                    <p className="text-gray-500">No ongoing projects matching your criteria.</p>
                  </div>
                ) : (
                  filteredProjects.map((project, index) => (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-4 my-2 border-y border-gray-100">
                        <div>
                          <p className="text-xs text-gray-400 font-semibold uppercase">Division</p>
                          <p className="text-xs md:text-sm font-bold text-gray-800 mt-1">{project.division}</p>
                        </div>
                        <div>
                        ...
                        <div>
                          <p className="text-xs text-gray-400 font-semibold uppercase">Date Start</p>
                          <p className="text-xs md:text-sm font-bold text-gray-800 mt-1 flex items-center gap-1">
                        ...
                        <div>
                          <p className="text-xs text-gray-400 font-semibold uppercase">Type</p>
                          <p className="text-xs md:text-sm font-bold text-gray-800 mt-1 flex items-center gap-1">
                      ...
                      <div className="flex items-center justify-between mt-4">
                        <div className="flex items-center gap-2">
                          <span className="text-xs text-gray-500 font-semibold">On-site Team:</span>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#17162b] text-white rounded-2xl p-6 shadow-lg relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1 font-semibold">On-Time Delivery</p>
                </div>
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
              ...
              <p className="text-xs text-gray-500 mt-3 text-center leading-relaxed">
                Key representations showing active execution across the Indian subcontinent.
              </p>
            </div>
          </div>
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[99999] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="bg-gray-50 rounded-xl p-4 my-6 grid grid-cols-2 gap-4 border border-gray-100 text-sm">
                <div>
                  <span className="text-gray-400 font-semibold text-xs block uppercase">Project ID</span>
                  <span className="font-bold text-gray-800 mt-0.5 block">#{selectedProjectDetails.id}</span>
                </div>
                <div>
                  <span className="text-gray-400 font-semibold text-xs block uppercase">Status</span>
                ...
                <div>
                  <span className="text-gray-400 font-semibold text-xs block uppercase">Division</span>
                  <span className="font-bold text-gray-800 mt-0.5 block">{selectedProjectDetails.division}</span>
                </div>
                <div>
                  <span className="text-gray-400 font-semibold text-xs block uppercase">Type</span>
                  <span className="font-bold text-gray-800 mt-0.5 block">{selectedProjectDetails.type}</span>
                </div>
              </div>

              <div className="space-y-4">
                <div>
                  <h4 className="text-xs text-gray-400 font-bold uppercase">Description</h4>
                  <p className="text-gray-600 text-sm leading-relaxed mt-1">
                    This project focuses on delivering highest-quality electrical infrastructure. Tasks include comprehensive engineering design, component sourcing, layout construction, quality tests, commissioning, and continuous monitoring to satisfy security and efficiency standards.
                  </p>
                </div>

                <div>
                  <h4 className="text-xs text-gray-400 font-bold uppercase mb-2">Scope of Operations</h4>
