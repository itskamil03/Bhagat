...
export default function UpcomingProjects() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800">
      ...
      {/* 3. MAIN UPCOMING PROJECT BOARD SECTION */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10 items-start">
          ...
          <div className="relative">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-900">Upcoming Project Board</h2>
              ...
              >
                {filteredProjects.length === 0 ? (
                  <div className="bg-white rounded-xl p-12 text-center border border-gray-200">
                    <p className="text-gray-500">No upcoming projects matching your criteria.</p>
                  </div>
                ) : (
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                        ...
                        <span className="bg-red-50 text-red-700 text-xs font-bold px-3 py-1 rounded-full shrink-0 h-fit self-start sm:self-center flex items-center gap-1">
                          <FaHammer className="text-xs text-red-600" />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#17162b] text-white rounded-2xl p-6 shadow-lg relative overflow-hidden">
              <h3 className="text-lg font-bold border-b border-white/10 pb-4 mb-6 flex items-center gap-2">
                ...
                <span>Upcoming Statistics</span>
              </h3>
              
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <p className="text-3xl font-extrabold text-white">03</p>
                  <p className="text-xs text-gray-400 mt-1 font-semibold">Contracted Projects</p>
                </div>
                <div>
                  <p className="text-3xl font-extrabold text-white">01</p>
                  <p className="text-xs text-gray-400 mt-1 font-semibold">State Covered</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1 font-semibold">Pre-planning Quality</p>
                </div>
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
              ...
              <p className="text-xs text-gray-500 mt-3 text-center leading-relaxed">
                Key representations showing planned execution across the Indian subcontinent.
              </p>
            </div>
          </div>
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[99999] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="text-xs text-gray-400 font-bold uppercase mb-2">Scope of Operations Planned</h4>
