...
export async function getFestivalGallery() {
  const res = await fetch(`${API_BASE}/api/gallery/festival`, {
    method: "GET",
    cache: "no-store",
  });
...
export async function createFestivalGallery(formData) {
  const res = await fetch(`${API_BASE}/api/gallery/festival/create`, {
    method: "POST",
    body: formData,
  });
...
export async function updateFestivalGallery(id, formData) {
  const res = await fetch(`${API_BASE}/api/gallery/festival/update/${id}`, {
    method: "PUT",
    body: formData,
  });
...
export async function deleteFestivalGallery(id) {
  const res = await fetch(`${API_BASE}/api/gallery/festival/delete/${id}`, {
    method: "DELETE",
  });
